...
var coreUtil = _interopDefault(require('@azure/core-util'));
var coreClient = _interopDefault(require('@azure/core-client'));
var coreRestPipeline = _interopDefault(require('@azure/core-rest-pipeline'));
...
const base64decode = (encodedString) => !coreUtil.isNodeLike ? atob(encodedString) : Buffer.from(encodedString, "base64").toString();
...
const coreClient$1 = __importStar(coreClient); // External library import
 // Grouped imports from the same module

class TrouterConfigClient extends coreClient$1.ServiceClient {
